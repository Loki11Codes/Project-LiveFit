      ...
      <div className="w-full max-w-[400px] z-10 transition-all duration-500 animate-in fade-in slide-in-from-bottom-4">
        <div className="card backdrop-blur-xl bg-[var(--surface-60)] border border-[var(--border)] p-8 rounded-2xl shadow-2xl">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold tracking-tight mb-2">Join LiveFit</h1>
            <p className="text-[12px] text-[var(--text-muted)] uppercase tracking-widest">Start your fitness journey</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="name" className="text-[11px] font-bold uppercase tracking-wider text-[var(--text-muted)] ml-1">Full Name</label>
              <input
                id="name"
                type="text"
                value={name}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[var(--accent)] text-[var(--accent-inv)] py-3 rounded-lg font-bold text-[14px] uppercase tracking-widest hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[var(--accent)]/20 mt-2"
            >
          ...
          <div className="mt-8 pt-6 border-t border-[var(--border)] text-center">
            <div className="text-[12px] text-[var(--text-muted)]">
              ...
              <Link href="/auth/signin" className="text-[var(--text)] font-bold hover:underline">
                Sign In
              </Link>
            </div>
          </div>
