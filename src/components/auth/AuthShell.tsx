      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-340 flex-col justify-center px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        >
          <motion.section
            ...
            className="relative hidden flex-col justify-center overflow-hidden rounded-4xl border border-black/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.9),rgba(255,248,221,0.82))] p-8 shadow-[0_18px_50px_rgba(18,31,51,0.1)] backdrop-blur-xl sm:p-10 xl:flex xl:col-span-5"
          >
          ...
          <motion.section
            variants={itemVariants}
            className="w-full flex-col justify-center flex rounded-4xl border border-black/10 bg-white/95 p-6 shadow-[0_22px_56px_rgba(17,24,39,0.14)] backdrop-blur-xl sm:mx-auto sm:p-10 xl:col-span-7"
          >
            <div className="mb-8">
